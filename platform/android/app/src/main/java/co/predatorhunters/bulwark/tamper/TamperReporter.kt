package co.predatorhunters.bulwark.tamper
...
object TamperReporter {
    // bulwark.v1.TamperKind ordinals — keep in sync with crates/bulwark-proto/proto/bulwark.proto.
    ...
    fun message(kind: Int): String = when (kind) {
        ...
        else -> "Bulwark protection changed on this device."
    }
}
