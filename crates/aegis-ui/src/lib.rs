//! aegis-ui — the local guardian dashboard + cluster admin (axum).
//!
...
/// build derives `ocr_agent`/`pinned` live from aegis-net's pinning registry +
/// aegis-agent's active apps.
