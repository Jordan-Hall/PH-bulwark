//! bulwark-proto — the shared gRPC/protobuf contract for Bulwark.
//!
...
/// Generated protobuf messages and gRPC service stubs for package `bulwark.v1`.
///
/// Re-exported at the crate root below for ergonomic `bulwark_proto::Verdict`
/// style paths.
pub mod v1 {
    tonic::include_proto!("bulwark.v1");
}
...
/// `bulwark-text` and the review UI. `as_str` round-trips with
...
/// `bulwark-policy` is the authority on actions; this is a shared default so
