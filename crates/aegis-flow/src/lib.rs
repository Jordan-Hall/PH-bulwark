//! # aegis-flow — flow classification, stream demux, and the broadcast-delay buffer.
//!
//! `aegis-flow` is the client data-plane stage between `aegis-net` (the
...
//! [`Action`](aegis_proto::v1::Action) back onto the held bytes
