...
/// pf rules installed under the Aegis anchor. Covers IPv4 and IPv6 TCP.
...
/// macOS teardown plan: flush only the Aegis anchor.
...
mod tests {
    ...
    fn linux_plan_has_ipv4_and_ipv6_local_routes() {
        ...
        assert!(rendered
            .iter()
            .any(|c| c.contains("nft add table inet aegis_vpn")));
    ...
    fn linux_teardown_deletes_routes_before_table() {
        ...
        assert_eq!(
            ...
            "nft delete table inet aegis_vpn"
        );
