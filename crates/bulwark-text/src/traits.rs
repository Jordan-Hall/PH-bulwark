//! bulwark-text internal contract (docs/design/interfaces.md): the explainable
//! rule layer.
//!
//! The canonical `Analyzer` trait now lives in `bulwark_core` and is implemented
...
use bulwark_proto::{GroomingSignal, TextSpan};

use crate::state::ThreadState;

/// bulwark-text internal contract: deterministic rules FIRST, classifier SECOND.
