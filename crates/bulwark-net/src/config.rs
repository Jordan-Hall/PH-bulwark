...
//!
//! These knobs layer under `bulwark_core::Config` (the orchestrator can embed
...
/// Configuration for the `bulwark-net` interception layer.
...
impl Default for NetConfig {
    fn default() -> Self {
        NetConfig {
            ...
            ca_common_name: "Bulwark Per-Install Root (DO NOT SHARE)".to_owned(),
