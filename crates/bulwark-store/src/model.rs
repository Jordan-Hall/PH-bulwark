...
use bulwark_proto::v1::{Action, AlertKind, Verdict};
...
pub struct StoredEvent {
    ...
    pub device: bulwark_core::DeviceId,
...
impl AuditRow {
    ...
    pub fn to_event(&self) -> StoredEvent {
        use bulwark_proto::v1::{Evidence, GroomingSignal};
        ...
        StoredEvent {
            device: bulwark_core::DeviceId(self.device_id.clone()),
            verdict,
...
/// `bulwark-proto` does not give us the app string on the verdict directly; it
...
mod tests {
    use super::*;
    use bulwark_proto::v1::{Category, Evidence, GroomingSignal, Severity};
