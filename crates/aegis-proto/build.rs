//! Compiles the Aegis protobuf contract into Rust — hermetically, with no system
//! `protoc`.
//!
...
//! stubs (one contract for aegis-client/-infer, aegis-server, aegis-cluster).
//! Output is pulled in via `tonic::include_proto!("aegis.v1")`.
